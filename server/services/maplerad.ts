...
export const issueVirtualAccount = async (customerId: string, currency: string) => {
  ...
  const endpoints = [
    { url: '/collections/virtual-account', payload: { customer_id: customerId, currency: currency.toLowerCase() } },
    { url: '/accounts', payload: { customer_id: customerId, currency: currency.toLowerCase() } },
    { url: '/wallets', payload: { customer_id: customerId, currency: currency.toLowerCase() } },
    { url: '/issuing/accounts', payload: { customer_id: customerId, currency: currency.toLowerCase() } }
  ];
